...
-   **`R/_common.R`**: Shared setup, packages, and configuration
-   **`R/functions/`**: Modular functions for data processing, modeling, plotting, and mapping
-   **`R/analysis/`**: Quarto documents for all analyses
-   **`data/`**: Raw data and cached processed datasets
