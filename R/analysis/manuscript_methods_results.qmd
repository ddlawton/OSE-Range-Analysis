...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  fig.retina = 2,
  dev = if (knitr::is_html_output()) c("svg", "png") else "png",
  fig.ext = if (knitr::is_html_output()) c("svg", "png") else "png"
)
...
save_gt_png <- function(gt_obj, filename, subfolder = "manuscript_methods_results") {
  save_gt_outputs(gt_obj, filename = filename, subfolder = subfolder, vwidth = 3000)
}
```
