...
#| fig-cap: "Ground cover by fertilizer treatment and mission across regions. Ground cover increased throughout the growing season across all regions, with minimal differences between control and fertilized treatments. No significant fertilizer × mission interaction was detected."
#| echo: false
#| message: false
#| warning: false
#| fig-width: 6
...
m1_raw_plot <- plot_mission_counts(village_count_data, mission = 1, show_legend = TRUE)
m2_raw_plot <- plot_mission_counts(village_count_data, mission = 2, show_legend = TRUE)
m3_raw_plot <- plot_mission_counts(village_count_data, mission = 3, show_legend = TRUE)

(m1_raw_plot / m2_raw_plot / m3_raw_plot) + 
