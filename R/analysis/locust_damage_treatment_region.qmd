...
for (i in seq_along(model_data)){
    ...
    mission_mods[[i]] <- readRDS(here::here("data", "model_objects", paste0("locust_damage_mission_", i, ".rds")))
...
# Combine diagnostic plots using patchwork
diagnostic_plots <- (mission_diagnostic_plots$m1 + mission_diagnostic_plots$m2) /
                    (mission_diagnostic_plots$m3 + patchwork::plot_spacer())
...
for (i in 1:3) {
  save_model_summary(mission_mods[[i]], paste0("mission_", i, "_model_summary"), out_path = here("outputs", "tables", "locust_damage_treatment_region"))
  save_emmeans_table(mission_emmeans[[i]]$emmeans, paste0("mission_", i, "_emmeans"), out_path = here("outputs", "tables", "locust_damage_treatment_region"))
  save_data_table(mission_emmeans[[i]]$pairwise, paste0("mission_", i, "_pairwise_comparisons"), out_path = here("outputs", "tables", "locust_damage_treatment_region"))
}
```
...
save_data_table(mission_emms, "combined_mission_emmeans", out_path = here("outputs", "tables", "locust_damage_treatment_region"))
```
